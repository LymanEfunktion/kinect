...
\newglossaryentry{Holonom}{name={Holonom},description={Ein holonomes System von Körpern zeichnet sich dadurch aus, dass sich die Lage der Körper durch n generalisierte Koordinaten q_1, q_2, \ldots, q_n beschreiben lässt, die gänzlich unabhängig voneinander sind}}

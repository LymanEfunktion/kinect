...
public abstract class AbstractWidgetElement implements Colors
{
	...
	protected Button addButton(String text, Composite parent, int style, GridData gridData)
	{
	...
	protected Label addLabel(String text, Composite parent, int style, GridData gridData)
	{
